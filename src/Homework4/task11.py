...
def top_names(year):
    ...
    """Данная функция обрабатывает каталог с именнами детей, за выбранный год
    и создает список с именами детей.Каталог должен находится в одной
    директории с файлом программы"""
